const ICON_PATHS = {
  ...
  // Тот же колокольчик, но «звонит» — дуги по бокам (для непрочитанных уведомлений)
  "bell-ring":  <><path d="M17.5 9A5.5 5.5 0 0 0 6.5 9c0 6-2.5 8-2.5 8h16s-2.5-2-2.5-8"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/><path d="M20.5 4.5C21.5 6 22 7.4 22 9"/><path d="M3.5 4.5C2.5 6 2 7.4 2 9"/></>,
  ...
  mail:        <><rect x="2.5" y="4.5" width="19" height="15" rx="2.5"/><path d="M3 7l8.15 5.43a1.5 1.5 0 0 0 1.7 0L21 7"/></>,
  target:      <><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="2"/></>,
  dollar:      <><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></>,
  ruble:       <><path d="M9 21v-6M9 13V4h4.5a4.5 4.5 0 0 1 0 9H6"/><line x1="6" y1="17.5" x2="13" y2="17.5"/></>,
  ...
  logout:      <><path d="M15 17l5-5-5-5"/><line x1="20" y1="12" x2="9" y2="12"/><path d="M12 3H6a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h6"/></>,
  ...
  // Серия сданных вовремя работ: огонёк вместо эмодзи 🔥 — эмодзи зависит от
  // шрифта системы и не красится токеном темы.
  flame:       <path d="M8.5 14.5A2.5 2.5 0 0 0 11 12c0-1.38-.5-2-1-3-1.07-2.14-.22-4.05 2-6 .5 2.5 2 4.9 4 6.5 2 1.6 3 3.5 3 5.5a7 7 0 1 1-14 0c0-1.15.43-2.29 1-3a2.5 2.5 0 0 0 2.5 2.5z"/>,
  sparkles:    <><path d="M12 3l1.9 4.6L18.5 9.5 13.9 11.4 12 16l-1.9-4.6L5.5 9.5l4.6-1.9z"/><path d="M18 15l.8 1.9 1.9.8-1.9.8L18 21l-.8-1.9-1.9-.8 1.9-.8z"/></>,
  "external-link": <><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></>,
  // Стрелки внутрь — «притянуть сюда». Обратная maximize: та разводит углы,
  // эта сводит их к центру.
  "pull-in":   <><polyline points="9 3 9 9 3 9"/><line x1="3" y1="3" x2="9" y2="9"/><polyline points="15 21 15 15 21 15"/><line x1="21" y1="21" x2="15" y2="15"/></>,
  ...
  // Ученик не пришёл: тот же человечек, но с крестиком вместо второго силуэта.
  "user-x":       <><path d="M15 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="8" cy="7" r="4"/><line x1="17" y1="8" x2="23" y2="14"/><line x1="23" y1="8" x2="17" y2="14"/></>,
  "trending-down": <><polyline points="23 18 13.5 8.5 8.5 13.5 1 6"/><polyline points="17 18 23 18 23 12"/></>,
  clock:           <><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></>,
  archive:         <><rect x="2.5" y="3.5" width="19" height="5" rx="1.5"/><path d="M4.5 8.5V19a2 2 0 0 0 2 2h11a2 2 0 0 0 2-2V8.5"/><line x1="10" y1="12.5" x2="14" y2="12.5"/></>,
