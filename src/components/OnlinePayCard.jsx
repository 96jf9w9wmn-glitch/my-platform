...
export default function OnlinePayCard({ user, student, debt = 0 }) {
  ...
  return (
    <div className="glass p-5">
      ...
      {/* Кто исполнитель услуги — потребитель должен понимать до оплаты
          (ст. 10 ЗоЗПП). Занятия оказывает репетитор, платформа в расчётах
          не участвует — та же конструкция закреплена в разделе 9 оферты. */}
      <p className="text-[11px] text-gray-400 text-center mt-2.5 leading-relaxed">
        ...
        Занятия оказывает и деньги получает репетитор — по вопросам оплаты,
        переноса и возврата обращайтесь к нему.
      </p>
    </div>
  )
}
