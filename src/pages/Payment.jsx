  ...
  return (
    <div className="p-4 sm:p-6">
      <div className="mb-4 sm:mb-6">
        <h1 className="text-2xl font-medium page-title">Финансы</h1>
        <p className="text-[15px] page-subtitle mt-0.5">Кто сколько должен, история оплат и доход за месяц. Настройки квитанций и онлайн-оплаты — в «Профиле».</p>
      </div>
          ...
          {debtors.length === 0 ? (
            ...
            <div className="glass overflow-hidden">
              {debtors.map((s) => {
                ...
                const pack = studentBilling(s).package
...
function PaymentGate(props) {
  ...
  return (
    <div className="p-4 sm:p-6">
      <h1 className="text-2xl font-medium page-title mb-1">Финансы</h1>
      <p className="text-[15px] page-subtitle mb-5">Оплаты, долги и доход по занятиям.</p>
