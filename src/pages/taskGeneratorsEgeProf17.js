...
export function t17TwoCirclesInRight() {
  return attempt(() => {
    ...
    return item({
      ...
      ans: Sstr(ex), num, model,
      solution: `Центр второй окружности удалён от AC на её радиус r, поэтому имеет координаты (r; y). Из внешнего касания (r + ${ru(r1)})² = (r − ${ru(r1)})² + y² находим y = 2√(${r1 === 1 ? "" : ru(r1)}r), а из касания гипотенузы получаем уравнение на r; его решение r = ${Sstr(ex)}.`,
    })
  })
}
