// Генераторы заданий ОГЭ по математике — по шаблонам ФИПИ.
//
...
//
// Модуль предмета: как taskGeneratorsInf.js и остальные, отдаёт две таблицы —
// GENERATORS_OGE (номер → функции) и GEN_META_OGE (номер → темы и типажи) — и
// подключается реестром taskGenerators.js ЛЕНИВО, по первому обращению к
// предмету. До 15.09.2026 всё это лежало в самом реестре, и любой, кому был
// нужен банк, получал разом все предметы (4 МБ кода, 2,8 с главного потока).
...
export const GEN_META_OGE = {
    ...
    9: [["Линейные уравнения", [["linear", "Линейное", t9Linear], ["linear-int", "Линейное (целые)", t9LinearInt], ["both-sides", "Линейное (x с двух сторон)", t9BothSides]]],
      ["Квадратные уравнения", [["quad", "Квадратное", t9Quad], ["quad-lead", "Квадратное (старший коэф.)", t9QuadLead], ["factor", "ax² = bx", t9Factor]]]],
    ...
    11: [["Знаки коэффициентов", [["signs-lin", "Знаки прямой", t11Signs], ["signs-parab", "Знаки параболы", t11SignsParab]]],
      ["График ↔ формула", [["linear", "Три линейные", t11Linear], ["mixed", "Смешанные семейства", t11Mixed]]]],
    12: [["Формулы физики", [["power", "Мощность тока", t12Power], ["kinetic", "Кинетическая энергия", t12Kinetic], ["potential", "Потенциальная энергия", t12Potential], ["centripetal", "Центростремит. ускорение", t12Centripetal], ["archimedes", "Сила Архимеда", t12Archimedes]]],
      ["Геометрические формулы", [["quad-area", "Площадь по диагоналям", t12QuadArea]]],
      ["Перевод температуры", [["f2c", "Фаренгейт → Цельсий", t12F2C], ["c2f", "Цельсий → Фаренгейт", t12C2F]]],
      ["Стоимость по формуле", [["well", "Колодец", t12Well]]]],
    13: [["Квадратные неравенства", [["quad", "Квадратное", t13Quad], ["coef", "ax²≷b", t13Coef], ["product", "Произведение", t13Product]]],
      ["Линейные неравенства", [["linear-text", "Линейное (луч)", t13LinearText]]],
      ["Системы неравенств", [["system-pic", "Система (рисунок)", t13SystemPic]]],
      ["Неравенство по рисунку", [["by-picture", "По рисунку", t13ByPicture]]]],
    14: [["Арифметическая прогрессия", [["arith-term", "n-й член", t14ArithTerm], ["arith-sum", "Сумма первых n", t14ArithSum]]],
      ["Равномерное изменение", [["two-rows", "Два ряда (амфитеатр)", t14TwoRows], ["braking", "Торможение", t14Braking], ["train", "Поезд", t14Train], ["cooling", "Охлаждение", t14Cooling]]],
      ["Геометрическая прогрессия", [["geom-half", "Половина (распад)", t14GeomHalf], ["bacteria", "Бактерии", t14Bacteria], ["ball", "Мячик", t14Ball]]]],
