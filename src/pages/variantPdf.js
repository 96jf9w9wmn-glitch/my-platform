...
function instructionParas({ examType, total, p1, p2, numbers = [], withFiles = [] }) {
  ...
  // Часть 2 у информатики — не «развёрнутый ответ», а работа за компьютером
  // (файл, таблица, программа): ответ у ОГЭ №11–12 как раз короткий.
  const part2Kind = inf ? ", которые необходимо выполнить на компьютере" : " с развёрнутым ответом"
  out.push(exam.p2
